...
air = pd.read_csv(data_path+'stcks/portbanksdemo.csv',dtype='str')

# create problems
prob_file = open('asset_classes_problems_html','r')
...
for problem in problems:
	for j in range(0,n):
		...
		# question
		qstn_file = open('problems/' + problem_code[:-1] + str(j) + 'Q.html','w')
		qstn_file.write(Q)
		qstn_file.close()

		# answer
		ansr_file = open('problems/' + problem_code[:-1] + str(j) + 'A.html','w')
		ansr_file.write(A)
		ansr_file.close()

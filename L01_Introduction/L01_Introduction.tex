...
\begin{frame}{\fttheory{NPV Revisited}}
	\begin{itemize}
		...
		\begin{equation}
			\boxed{
			\text{NPV}=-7.5\musd+\frac{10\musd}{1.02}
			}
		\end{equation}
		You should invest. 
...
\begin{frame}{\fttheory{Q1: What if the NPV is negative?}}
	\begin{itemize}
		...
		\item Suppose instead that the security costs $10\musd$
		\item The NPV would seem to be negative
		\item Solution: ``borrow'' the security, sell it for $7.5\musd$, invest the proceeds at $2\%$. In one year, repay the lender $10\musd$.
		\item In this case, the NPV is 
		\begin{equation}
			\boxed{
			\text{NPV}=+10\musd-\frac{10\musd}{1.02}>0
			}
		\end{equation}
...
\begin{frame}{\fttheory{Q2: What if you finance your investment with debt?}}
	...
	\item In this case,
		...
		\end{equation}
	\item (what if instead of $10\musd$, the investment only produces $0.5\musd$?)
	\item This is called \textit{leverage} (or \textit{margin})
	\end{itemize}
\end{frame}
...
\begin{frame}{\fttheory{Q4: What if cash-flows are risky?}}
	...
	\item In this case,
		\begin{equation}
			\text{NPV}=-7.5\musd+\frac{???\musd}{1.02}.
		\end{equation}
	\end{itemize}
\end{frame}
...
\begin{frame}{\fttheory{Q6: What if everyone wants the investment?}}
	...
	\item Consider the original example:
		...
		\end{equation}
	\item If someone invested $85\musd$ instead of $7.5\musd$, their NPV would still be positive
...
\begin{frame}{\ftexampl{Shorting}}
	\small
	Let's continue with the Microsoft example. Recall that on 2008-01-31, Microsoft traded for 32.6 USD. Suppose you bought 1,000 shares. On 2008-, MSFT traded for. What was your profit/loss?
	\pause
	{\color{blue} You made a profit of $=$}
\end{frame}

...
\begin{frame}{\ftheader{Lecture 0.1: Introduction}}
	\begin{itemize}
		\item Lay down some basic vocabulary
...
\begin{frame}{\ftheader{NPV Revisited}}
	\begin{itemize}
...
\begin{frame}{\ftexampl{Q3: What if different terms have different yields?}}
	...
	\item In this case,
		\begin{equation}
			\text{NPV}=-.75\musd+\frac{1\musd}{1.01}+\frac{1\musd}{1.03}.
		\end{equation}
	\end{itemize}
\end{frame}
...
\begin{frame}{\ftexampl{Q5: What about the economy?}}
	\begin{itemize}
	\item In this case,
		\begin{equation}
			\text{NPV}=-.75\musd+\frac{1\musd}{1.02}.
...
%=============================================================================%
\begin{frame}{\ftdata{Order Execution}}
\begin{itemize}
...
%   MARGIN                                                                    %
%=============================================================================%
\begin{frame}{\ftdata{Leverage: Implementation}}
\begin{itemize}
\item Investors can borrow from financial institutions to finance the purchase of securities
\item We call this buying on margin
\item There are two margin requirements

...
\begin{frame}{\ftheader{Option Basics}}
	\begin{itemize}
	\item A \textit{financial option} is a contract that gives its owner the \underline{right} (but not the \underline{obligation}) to purchase or sell an asset at a pre-specified price at some future date
...
\begin{frame}{\ftvocab{Understanding Option Contracts}}
	\begin{itemize}
		...
		\end{itemize}
		\item Option owners are \textit{long} and option writers are \textit{short}. 
...
\begin{frame}{\ftexampl{Examples: Put-Call Parity}}
\end{frame}

...
\begin{frame}{\ftvocab{Vocabulary}}
	\begin{itemize}
		...
		\item The \textit{spot price} is the actual market price of the commodity at the time of the delivery.
	\end{itemize}
\end{frame}

\begin{frame}{\fttheory{Trading Strategies}}
	\begin{itemize}
		\item Long position: commit to \textit{purchase} asset
		\item Short position: commit to \textit{deliver} asset
...
\begin{frame}{\fttheory{Pricing Forwards}}
   \begin{itemize}
...
\begin{frame}{\ftexampl{Pricing Forwards: Example}}
    \begin{itemize}

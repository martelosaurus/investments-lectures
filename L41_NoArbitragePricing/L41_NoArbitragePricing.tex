...
\begin{frame}{\fttheory{Alpha: Fundamental}}
	\begin{itemize}
		\item Recall 
			...
			\end{equation}
		\item The idea behind fundamental analysis is to identify $\alpha$ by forecasting cash flows (and the dividends or buybacks that follow)
		\item Example: according to the CAPM, Walmart should have a monthly return of 25bps. However, after studying consumer behavior, you forecast abnormally high sales for Walmart due to Covid ``prepping.'' Walmart will have a return of 5bps next month \text{in addition to} the 25bps it should return according to the CAPM. 
		\item The benefit of fundamental analysis is that is forward looking (whereas statistical analysis is backward looking)
	\end{itemize}
\end{frame}

...
\begin{frame}{\fttheory{Two Kinds of Alpha}}
	\begin{itemize}
		\item There are two ways of thinking about $\alpha$, one is like ``technical analysis,'' the other like ``fundamental analysis.''
	\end{itemize}
\end{frame}

\begin{frame}{\ftexampl{Alpha I}}
	\begin{itemize}
		\item The alpha depends on how long you believe it will take the market to catch-up
	\end{itemize}
\end{frame}

\begin{frame}{\ftexampl{Alpha I}}
	On 2020-10-09, Tesla was trading for 433.95 USD. It has a beta of 1.37 If you believe instead it should be trading for 450.50 USD, what is its alpha? Suppose that the risk-free rate is zero.
	\pause
	{\color{blue}
		According to the CAPM, Tesla should have a return of
		\begin{equation}
			E[r_{\text{TSLA}}]=r_{F}+\beta_{\text{TSLA}}E[r_{M}-r_{F}]=
		\end{equation}
	}
\end{frame}

\begin{frame}{\ftexampl{Alpha II}}
	On 2020-10-09, Tesla was trading for 433.95 USD. If you believe instead it should be trading for 450.50 USD, what is its alpha?
	\pause
	{\color{blue}
